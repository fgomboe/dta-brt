...
public class GeneratePopulation_final2
{
        ...
        try {
...

            {
                ...
                if (st_START.equals("YES") && (st_END.equals("YES")) || (producto.equals("UNIVIAJE-II"))) {
                    ...
                    Activity activity1 = populationFactory.createActivityFromCoord("dummy", homeCoordinates);
                    ...
                    Activity activity2 = populationFactory.createActivityFromCoord("dummy", homeCoordinates2);
            ...
            popWriter.write("./input/plans_sitm_cali_01.04.2014_40porc_final_dummy.xml");
