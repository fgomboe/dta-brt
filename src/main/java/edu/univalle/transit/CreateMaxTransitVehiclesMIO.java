...
public class CreateMaxTransitVehiclesMIO
{
    ...
    public void createVechiclesTypes() {
        ...
        try {
...

            {
                ...
                for (int i = 1; i <= MAX_NUMBER_OF_VEHICLES * 2; ++i) {
                    org.matsim.vehicles.Vehicle bus = vehiculos.getFactory()
                            .createVehicle(Id.create(ruta + "_" + i, org.matsim.vehicles.Vehicle.class), articulado);
