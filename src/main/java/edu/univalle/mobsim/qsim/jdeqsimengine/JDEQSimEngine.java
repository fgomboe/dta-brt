...
import edu.univalle.mobsim.jdeqsim.util.Timer;
...
class JDEQSimEngine implements MobsimEngine, ActivityHandler
{
    ...
    public JDEQSimEngine(Scenario scenario, EventsManager eventsManager, AgentCounter agentCounter,
    ...
    public boolean handleActivity(MobsimAgent agent) {
        ...
        new Vehicle(scheduler, ((HasPerson) agent).getPerson(),
                scenario.getConfig().plans().getActivityDurationInterpretation());
        numberOfAgents++;
        return true;
    }
