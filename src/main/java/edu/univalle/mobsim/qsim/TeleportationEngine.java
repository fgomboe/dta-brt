...
public final class TeleportationEngine implements DepartureHandler, MobsimEngine, VisData
{
    /**
     ...
     */
    private final Queue<Tuple<Double, MobsimAgent>> teleportationList = new PriorityQueue<>(30,
        ...
        while (teleportationList.peek() != null) {
            ...
            if (entry.getFirst() <= now) {
                ...
                this.eventsManager.processEvent(
                        new TeleportationArrivalEvent(this.internalInterface.getMobsim().getSimTimer().getTimeOfDay(),
                                personAgent.getId(), distance));
