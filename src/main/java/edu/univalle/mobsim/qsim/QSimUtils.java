...
public class QSimUtils
{
    ...
    public static QSim createDefaultQSim(final Scenario scenario, final EventsManager eventsManager) {
        org.matsim.core.controler.Injector injector = org.matsim.core.controler.Injector
                .createInjector(scenario.getConfig(), new StandaloneQSimModule(scenario, eventsManager));
    ...
    public static QSim createQSim(final Scenario scenario, final EventsManager eventsManager,
        ...
        org.matsim.core.controler.Injector injector = org.matsim.core.controler.Injector.createInjector(
                scenario.getConfig(),
                org.matsim.core.controler.AbstractModule.override(
                        Collections.singleton(new StandaloneQSimModule(scenario, eventsManager)),
