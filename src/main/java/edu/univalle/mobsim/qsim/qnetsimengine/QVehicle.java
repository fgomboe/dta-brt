...
import edu.univalle.mobsim.framework.DriverAgent;
...
public class QVehicle extends QItem implements MobsimVehicle
{
    ...
    public org.matsim.core.mobsim.framework.MobsimDriverAgent getDriver() {
        if (this.driver instanceof MobsimDriverAgent) {
            return (org.matsim.core.mobsim.framework.MobsimDriverAgent) this.driver;
        }
    ...
    public void setDriver(final DriverAgent driver) {
        if (driver != null) {
            if (this.driver != null && !this.driver.getId().equals(driver.getId())) {
                throw new RuntimeException("A driver (" + this.driver.getId() + ") " + "is already set in vehicle "
                        + this.getId() + ". " + "Setting agent " + driver.getId().toString() + " is not possible!");
            }
        }
    ...
    public String toString() {
        return "Vehicle Id " + getId() + ", driven by (personId) " + this.driver.getId() + ", on link "
