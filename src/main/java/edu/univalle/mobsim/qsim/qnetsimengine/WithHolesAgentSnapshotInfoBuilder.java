...
class WithHolesAgentSnapshotInfoBuilder extends AbstractAgentSnapshotInfoBuilder
{
    ...
    public double calculateVehicleSpacing(double linkLength, double numberOfVehiclesOnLink,
        ...
        double vehLen = Math.min(linkLength / (overallStorageCapacity), // number of ``cells''
    ...
    @Override
    public double calculateDistanceOnVectorFromFromNode2(double length, double spacing, double lastDistanceFromFNode,
