...
public interface PassengerAccessEgress
{
     ...
     */
    public boolean handlePassengerEntering(final PTPassengerAgent agent, MobsimVehicle vehicle,
            Id<TransitStopFacility> fromStopFacilityId, final double time);
     ...
     */
    public boolean handlePassengerLeaving(final PTPassengerAgent agent, MobsimVehicle vehicle, Id<Link> toLinkId,
            final double time);
