...
public interface TransitStopHandler
{
    ...
    /**
     * <p>
     * Handles the loading and unloading for a transit vehicle. Given a list of passengers that
     ...
     * </p>
     * <p>
     * The method must return the time how long the vehicle will have to stay at least at the stop
