...
import edu.univalle.mobsim.qsim.pt.MobsimDriverPassengerAgent;
...
public final class TransitAgent implements MobsimDriverPassengerAgent, PlanAgent, HasPerson
{
    ...
    private TransitAgent(final Person p, final Netsim simulation) {
        basicAgentDelegate = new BasicPlanAgentImpl(p.getSelectedPlan(), simulation.getScenario(),
                simulation.getEventsManager(), simulation.getSimTimer());
    ...
    @Override
    public final boolean getEnterTransitRoute(TransitLine line, TransitRoute transitRoute,
