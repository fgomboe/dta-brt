...
public final class PlanBasedDriverAgentImpl implements DriverAgent
{
    ...
    public final Id<Link> chooseNextLinkId() {
        ...
        List<Id<Link>> routeLinkIds = ((NetworkRoute) this.basicPlanAgentDelegate.getCurrentLeg().getRoute())
                .getLinkIds();
    ...
    public final boolean isWantingToArriveOnCurrentLink() {
        ...
        final List<Id<Link>> routeLinkIds = ((NetworkRoute) this.basicPlanAgentDelegate.getCurrentLeg().getRoute())
                .getLinkIds();
