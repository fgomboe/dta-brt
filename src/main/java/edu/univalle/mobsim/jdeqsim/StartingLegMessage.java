...
public class StartingLegMessage extends EventMessage
{
    ...
    public void processEvent() {
        ...
        event = new ActivityEndEvent(this.getMessageArrivalTime(), vehicle.getOwnerPerson().getId(),
                vehicle.getCurrentLinkId(), vehicle.getPreviousActivity().getFacilityId(),
        ...
        event = new PersonDepartureEvent(this.getMessageArrivalTime(), vehicle.getOwnerPerson().getId(),
                vehicle.getCurrentLinkId(), vehicle.getCurrentLeg().getMode());
