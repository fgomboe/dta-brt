...
public class LeaveRoadMessage extends EventMessage
{
    ...
    public void processEvent() {
        ...
        event = new LinkLeaveEvent(this.getMessageArrivalTime(), vehicle.getOwnerPerson().getId(),
                road.getLink().getId(), Id.create(vehicle.getOwnerPerson().getId(), org.matsim.vehicles.Vehicle.class));
