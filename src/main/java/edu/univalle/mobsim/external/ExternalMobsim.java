...
package edu.univalle.mobsim.external;
...
public class ExternalMobsim implements Mobsim
{
    ...
    protected void writeConfig(final String iterationPlansFile, final String iterationEventsFile,
            final String iterationConfigFile) throws FileNotFoundException, IOException {
    ...
    protected void runExe(final String iterationConfigFile) throws FileNotFoundException, IOException {
        ...
        int timeout = ((SimulationConfigGroup) this.scenario.getConfig().getModule(SimulationConfigGroup.GROUP_NAME))
                .getExternalTimeOut();
